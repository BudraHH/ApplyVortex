...
const DialogHeader = ({
  ...
  <div
    className={cn("flex flex-col text-center sm:text-left space-y-2 md:space-y-3 lg:space-y-4", className)}
    {...props} />
)
...
const DialogFooter = ({
  ...
  <div
    className={cn("flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2 md:space-x-3 lg:space-x-4", className)}
    {...props} />
)
