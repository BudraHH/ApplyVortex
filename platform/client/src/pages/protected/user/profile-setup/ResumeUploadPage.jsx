...
function ResumeCard({ resume, onDelete }) {
    ...
    return (
        <div className="group relative rounded-lg border border-slate-100 hover:border-slate-200 bg-white transition-all duration-300 p-4"
        >
            <div className="flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                    <h4 className="text-lg font-semibold text-slate-900 truncate mb-4">
                        {resume.name}
                    </h4>
                    ...
                    <div className="flex items-center text-sm text-slate-500 gap-4">
                        ...
                        {resume.parsingStatus === PARSING_STATUS.SUCCESS ? (
                            <>
                                <span className="w-1 h-1 rounded-full bg-slate-400" />
                                <span className="text-emerald-600 font-medium flex items-center gap-4">
                                    Parsed
                                </span>
                            </>
                            ...
                            <>
                                <span className="w-1 h-1 rounded-full bg-slate-300" />
                                <span className="text-brand-600 font-medium flex items-center gap-4">
                ...
                <div className="flex items-center gap-4">
                    ...
                    {/* Only show delete if passed (optional in view mode, but good for cleanup) */}
                    {onDelete && (
                        <Button
                            variant="ghost"
                            size="icon"
...
export default function ResumeUploadPage() {
    ...
    return (
        <div className="w-full h-full mx-auto bg-white rounded-xl overflow-y-auto space-y-4 p-4">
            {/* Header */}
            ...
            <div className="space-y-4">
                <div className={`flex items-center ${isLoading || isRefreshing ? 'bg-slate-100 text-slate-700 border-slate-200' : 'bg-emerald-50/50 text-emerald-800 border-emerald-200'} rounded-lg text-sm border gap-4 p-4`}>
                    <Clock className="h-4 w-4 flex-shrink-0" />
                    <span>Select "Edit" below if you wish to replace this resume.</span>
                </div>
                <div className="flex items-center bg-slate-50 text-slate-700 rounded-lg text-sm border border-slate-200 gap-4 p-4">
                ...
                {!isLoading && !isRefreshing && !isEdit && !currentResume && (
                    <motion.div
                        ...
                        className="flex flex-col items-center justify-center text-center border-2 border-dashed border-slate-300 rounded-3xl bg-slate-50 p-4"
                    >
                        <div className="bg-white rounded-full relative shadow-sm p-4 mb-4">
            ...
            <div className="flex flex-row justify-end items-center border-t border-slate-200 gap-4 pt-4">
                {isEdit ? (
                    <div className="flex items-center gap-4">
                        <Button
                            type="button"
