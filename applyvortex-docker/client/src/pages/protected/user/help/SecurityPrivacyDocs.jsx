...
const InfoCard = ({ icon: Icon, title, children, color = "blue" }) => {
    ...
    return (
        <div className="group rounded-xl bg-white border border-slate-100 hover:border-slate-200 transition-all duration-300 p-6">
            <div className={`w-12 h-12 rounded-xl flex items-center justify-center transition-colors ${colorClasses[color] || colorClasses.blue} mb-4`}>
...
export default function SecurityPrivacyDocs() {
    ...
    return (
        ...
        >
            {/* Header */}
            <div className="flex flex-row justify-between items-center border-b border-slate-100 bg-slate-50/50 sticky top-0 z-20 backdrop-blur-sm px-6 py-4 gap-4">
                <div>
                    <div className="flex items-center text-sm text-blue-600 font-bold uppercase tracking-wider gap-2 mb-2">
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar">
                <div className="mx-auto p-6 space-y-8 max-w-5xl">
                    ...
                    {/* Hero Section */}
                    <div className="relative rounded-xl bg-slate-900 overflow-hidden text-left p-8">
                        ...
                        <div className="relative z-10 flex flex-col space-y-4">
                            <h2 className="text-3xl font-black text-white tracking-tight">Your Data, Your Control.</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <InfoCard icon={Download} title="Data Portability" color="purple">
                            ...
                            <p className="flex items-center text-purple-700 font-medium bg-purple-50 rounded-lg w-fit gap-2 mt-4 p-3">
                    ...
                    <div className="bg-blue-50 border border-blue-100 rounded-xl flex items-start p-6 gap-4">
                        <CheckCircle2 className="w-5 h-5 text-blue-600 shrink-0 mt-1" />
                        <div className="text-sm text-blue-800">
                            <strong className="block font-semibold mb-2">Compliance Note</strong>
